...
RTP_thread_5Tails::RTP_thread_5Tails ( wxFrame* parent , wxTextCtrl* UDP_TEXT1 , wxImage* Image , int free_bytes_int , int SUPPORT , int sock_descriptor , bool working )
{
...
wxThread::ExitCode RTP_thread_5Tails::Entry ()
{
