#ifndef SHARINGAN_SERVER_RTP_5TAILS_H_
#define SHARINGAN_SERVER_RTP_5TAILS_H_
...
class Sharingan_Server_RTP_5Tails
{
    ...
    public: Sharingan_Server_RTP_5Tails ( std::string ADDR , int BYTE )
	{
	...
	public: static void sharePictures      ( std::list<sockaddr_in>** cliaddr_list , int index   , int sockfd  , int input_bytes , std::string* md5_list ) ;
