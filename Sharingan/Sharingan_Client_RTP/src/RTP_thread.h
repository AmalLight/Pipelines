#ifndef RTP_THREAD_H_
#define RTP_THREAD_H_
...
class RTP_thread : public wxThread
{
    ...
    public: RTP_thread ( wxFrame* parent , wxTextCtrl* UDP_TEXT1 , wxImage* Image , int forbytes , int SUPPORT , int sock_descriptor , bool working ) ;
