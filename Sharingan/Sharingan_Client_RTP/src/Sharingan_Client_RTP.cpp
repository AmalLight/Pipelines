#include "Sharingan_Client_RTP.h"
         ...
         wxFrame ( parent, id, title, pos, size, style )
{
    ...
    SetTitle   ( wxT    ( "Sharingan_Client_RTP"                           ) ) ;
...
void MyFrame::OKpressed ( wxCommandEvent &event )  // wxGlade: MyFrame.<event_handler>
{
	...
	if ( ! error )
	{
	    ...
	    if ( ( ! working ) && ( working = true ) )
	    {
	    	...
	    	RTP_thread* RTP1 = new RTP_thread ( this , this->UDP_TEXT1 , this->imageArray [ 0 ] , free_bytes_int , this->SUPPORT , this->sock_descriptor1 , false ) ;
	    	RTP_thread* RTP2 = new RTP_thread ( this , this->UDP_TEXT1 , this->imageArray [ 1 ] , free_bytes_int , this->SUPPORT , this->sock_descriptor2 ,  true ) ;
	    	RTP_thread* RTP3 = new RTP_thread ( this , this->UDP_TEXT1 , this->imageArray [ 2 ] , free_bytes_int , this->SUPPORT , this->sock_descriptor3 ,  true ) ;
	    	RTP_thread* RTP4 = new RTP_thread ( this , this->UDP_TEXT1 , this->imageArray [ 3 ] , free_bytes_int , this->SUPPORT , this->sock_descriptor4 ,  true ) ;
...
void MyFrame::onNumberUpdate( wxCommandEvent &event )
{
	int n ; switch ( ( n = event.GetInt () ) )
	{
	    case 1: // working good
		    ...
		    SetTitle ( std::string ( "Sharingan for " + this->ip_addr ) ) ;
	    ...
	    default: // >= 2
	    	...
	    	RTP_thread* RTP = new RTP_thread ( this , this->UDP_TEXT1 , Image , ( MyFrame::MAXLINE * forbytes ) , this->SUPPORT , sockfd , true ) ;
...
void MyFrame::OnLeftClick ( wxMouseEvent & event )
{
	...
	sockaddr_in servaddr ;
                ...
                servaddr.sin_port        = htons     (  MyFrame:: PORT5 ) ;
