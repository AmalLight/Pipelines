...
ssh 192.168.31.1 -t  " \
\
sudo iptables  -I  OUTPUT  -o  wlan0  -s  192.168.43.0/24  -p  tcp  --match  multiport  --dports  6660,6666,6667,6668,6697,6999  -j  ACCEPT ; \
sudo iptables  -I  OUTPUT  -o  wlan0  -s  192.168.43.0/24  -p  tcp  --match  multiport  --sports  1024:5000                      -j  ACCEPT ; \
sudo iptables  -I  INPUT   -i  wlan0  -d  192.168.43.0/24  -p  tcp  --match  multiport  --sports  6660,6666,6667,6668,6697,6999  -j  ACCEPT ; \
sudo iptables  -I  INPUT   -i  wlan0  -d  192.168.43.0/24  -p  tcp  --match  multiport  --dports  1024:5000                      -j  ACCEPT ; \
\
